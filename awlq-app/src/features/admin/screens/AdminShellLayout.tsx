...
const ADMIN_MENU = [
  ...
  { href: "/admin/desafio-semanal", label: "Desafio Semanal" },
  { href: "/admin/gamificacao", label: "Gamificacao" },
  { href: "/admin/temas", label: "Temas da Comunidade" },
...
const BREADCRUMB_MAP: Record<string, string> = {
  ...
  "/admin/certificacoes": "Certificacoes",
  "/admin/email": "Email",
  ...
  "/admin/arena": "Arena",
  "/admin/desafio-semanal": "Desafio Semanal",
  "/admin/gamificacao": "Gamificacao",
  "/admin/temas": "Temas da Comunidade",
