...
export function Header({ xp, name, onEditProfile }: { xp: number; name: string; onEditProfile?: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b-2 border-[var(--pixel-border)] bg-[var(--pixel-bg)]/90 backdrop-blur">
      <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between gap-3 px-4 py-3 xl:px-8">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="truncate font-[var(--font-body)] text-sm text-[var(--pixel-subtext)]">
              Player: {name || "Anonimo"}
            </p>
          </div>
        </Link>
        ...
        <button
          ...
          className="border-2 border-[var(--pixel-border)] bg-[var(--pixel-card)] px-3 py-2 font-[var(--font-pixel)] text-[10px] uppercase md:hidden"
        >
      ...
      {mobileMenuOpen ? (
        <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-3 px-4 pb-3 md:hidden xl:px-8">
          <div className="flex items-center gap-2 border-2 border-[var(--pixel-border)] bg-[var(--pixel-card)] px-3 py-2">
            <span className="font-[var(--font-pixel)] text-[10px] uppercase">XP {xp}</span>
            <LevelBadge xp={xp} />
          </div>
