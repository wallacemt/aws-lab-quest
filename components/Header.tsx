      ...
      <div className="mx-auto flex w-full max-w-[1600px] items-center gap-3 px-4 py-3 xl:px-8">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <div className="relative" ref={dropdownRef}>
            <button onClick={() => setDropdownOpen((open) => !open)} aria-expanded={dropdownOpen} aria-haspopup="true"  className="flex items-center justify-center hover:border-[var(--pixel-primary)]">
